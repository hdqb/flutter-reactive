...
import 'package:ipwf/model/actions_actions_generated.dart';
...
class Action {
  ...
  void doAction() {
    Ipwf.doAction(serialized);
  }
}

class ActionFactory {
  static Action createMainPageButtonClick(String name) {
    final builder = new fb.Builder(initialSize: 1024);
    final buttonClicked = new ButtonClickedObjectBuilder(name:name).finish(builder) ;
